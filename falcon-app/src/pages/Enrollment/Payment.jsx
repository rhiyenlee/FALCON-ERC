...
<<<<<<< HEAD
      ...
      <p className="bpi-acc-details"> Account Name: 
          F.A.L Conducive Engineering Review Center <br />
          Account No.: 0969612666</p>
     </div>
     ...
     <div className="pnb-payment-col">
      ...
      <p className="pnb-acc-details"> Account Name: 
            F.A.L Conducive Engineering Review Center <br />
            Account No.: 165310223342</p>
    </div>

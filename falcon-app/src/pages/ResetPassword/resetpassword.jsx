    ...
    <div>
        <div className="reset-pass"></div>
            ...
            <label className="label-new">New Password</label><br/>
              <input type="password" name="new" className='input-new' placeholder='New Password' required></input><br/>

              <label className="label-confirm">Confirm New Password</label><br/>
              <input type="password" name="confirm" className='input-confirm' placeholder='Confirm New Password' required></input><br/>
